...
echo "SuC"
wget -O SuC.json 'https://overpass-api.de/api/interpreter?data=%5Bout%3Ajson%5D%5Btimeout%3A25%5D%3Barea(3600295480)-%3E.searchArea%3B((%20%20node%5B%22amenity%22%3D%22charging_station%22%5D(if%3A%20t%5B%22socket%3Atesla_supercharger%22%5D%20%3E%200)%20%20%20%20(area.searchArea)%3B)%3B(%20%20node%5B%22amenity%22%3D%22charging_station%22%5D(if%3A%20t%5B%22socket%3Atesla_supercharger_ccs%22%5D%20%3E%200)%20%20%20%20(area.searchArea)%3B)%3B(%20%20node%5B%22man_made%22%3D%22charge_point%22%5D(if%3A%20t%5B%22socket%3Atesla_supercharger%22%5D%20%3E%200)%20%20%20%20(area.searchArea)%3B)%3B(%20%20node%5B%22man_made%22%3D%22charge_point%22%5D(if%3A%20t%5B%22socket%3Atesla_supercharger_ccs%22%5D%20%3E%200)%20%20%20%20(area.searchArea)%3B)%3B)%3Bout%20body%3B%3E%3Bout%20skel%20qt%3B'
sleep 60
